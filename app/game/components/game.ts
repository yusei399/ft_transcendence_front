...
type Ball = {
  ...
  export class Game {
	...
	constructor(canvas: HTMLCanvasElement) {
	  ...
	  this.player2 = { width: 10, height: 80, x: canvas.width - 10, y: canvas.height / 2 - 40, speedY: 0 };
	...
	private setupControls(): void {
	  window.addEventListener('keydown', event => {
		switch (event.key) {
		  case 'w': this.player1.speedY = -5; break;
		  case 's': this.player1.speedY = 5; break;
		  case 'ArrowUp': this.player2.speedY = -5; break;
		  case 'ArrowDown': this.player2.speedY = 5; break;
		}
	  });
	  ...
	  window.addEventListener('keyup', event => {
		switch (event.key) {
		  case 'w':
		  case 's': this.player1.speedY = 0; break;
		  case 'ArrowUp':
		  case 'ArrowDown': this.player2.speedY = 0; break;
		}
	  });
	}
